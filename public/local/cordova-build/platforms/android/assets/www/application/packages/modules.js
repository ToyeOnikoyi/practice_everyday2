...
install("mrt:bootstrap-3");                                                  // 81
install("url");                                                              // 82
install("oauth");                                                            // 83
install("accounts-oauth");                                                   // 84
install("service-configuration");                                            // 85
install("oauth2");                                                           // 86
install("spacebars");                                                        // 87
install("templating");                                                       // 88
install("facebook");                                                         // 89
...
install("reactive-dict");                                                    // 95
install("session");                                                          // 96
install("less");                                                             // 97
install("accounts-ui-unstyled");                                             // 98
install("accounts-ui");                                                      // 99
install("fastclick");                                                        // 100
install("ui");                                                               // 101
install("iron:core");                                                        // 102
install("iron:dynamic-template");                                            // 103
install("iron:layout");                                                      // 104
install("iron:url");                                                         // 105
install("iron:middleware-stack");                                            // 106
install("iron:location");                                                    // 107
install("iron:controller");                                                  // 108
install("iron:router");                                                      // 109
install("meteoric:ionic");                                                   // 110
install("pcjpcj2:ratchet");                                                  // 111
install("momentjs:moment");                                                  // 112
install("mrt:jquery-ui");                                                    // 113
install("raix:eventemitter");                                                // 114
install("raix:eventstate");                                                  // 115
install("raix:push");                                                        // 116
install("linto:jquery-ui");                                                  // 117
install("fourseven:scss");                                                   // 118
install("fortawesome:fontawesome");                                          // 119
install("themeteorchef:bert");                                               // 120
install("autoupdate");                                                       // 121
install("meteor-platform");                                                  // 122
install("aldeed:simple-schema");                                             // 123
install("aldeed:collection2-core");                                          // 124
install("aldeed:schema-index");                                              // 125
install("aldeed:schema-deny");                                               // 126
install("aldeed:collection2");                                               // 127
install("livedata");                                                         // 128
install("aldeed:autoform");                                                  // 129
install("maxharris9:meteor-bootstrap-slider");                               // 130
install("johannesma:meteor-flexslider");                                     // 131
install("muqube:autoform-selectable");                                       // 132
install("rcy:nouislider");                                                   // 133
install("muqube:autoform-nouislider");                                       // 134
install("crosswalk");                                                        // 135
install("webapp");                                                           // 136
install("hot-code-push");                                                    // 137
install("mobile-status-bar");                                                // 138
install("launch-screen");                                                    // 139
install("logging");                                                          // 140
install("mdg:validation-error");                                             // 141
                                                                             // 142
///////////////////////////////////////////////////////////////////////////////
