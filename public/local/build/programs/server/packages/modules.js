...
install("accounts-ui");
install("meteoric:ionic");
install("pcjpcj2:ratchet");
...
install("maxharris9:meteor-bootstrap-slider");
install("johannesma:meteor-flexslider");
install("muqube:autoform-selectable");
install("rcy:nouislider");
install("muqube:autoform-nouislider");
install("crosswalk");
install("livedata");
