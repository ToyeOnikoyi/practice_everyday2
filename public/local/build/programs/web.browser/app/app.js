...
Template.confirm.onCreated(function () {                                                                              // 1
  ...
  var countdown = new ReactiveCountdown(24, {                                                                         // 4
    ...
    completed: function () {                                                                                          // 15
      function completed() {}                                                                                         // 15
                                                                                                                      //
      return completed;                                                                                               // 15
    }()                                                                                                               // 15
                                                                                                                      //
...
Template.confirm.helpers({                                                                                            // 28
  getCountdown: function () {                                                                                         // 30
    function getCountdown() {                                                                                         // 28
                                                                                                                      //
      return countdown.get();                                                                                         // 32
    }                                                                                                                 // 33
                                                                                                                      //
    return getCountdown;                                                                                              // 28
  }()                                                                                                                 // 28
});                                                                                                                   // 28
                                                                                                                      //
Template.confirm.events({                                                                                             // 37
  'click .confirm': function () {                                                                                     // 38
    function clickConfirm(event) {                                                                                    // 38
      ...
      Router.go('/success');                                                                                          // 59
                                                                                                                      ...
                                                                                                                      //
    return clickConfirm;                                                                                              // 38
  }(),                                                                                                                // 38
                                                                                                                      //
  'click .confirmAgain': function () {                                                                                // 62
    function clickConfirmAgain(event) {                                                                               // 62
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                      //
Template.homeIndex.onCreated(function () {                                                                            // 1
  function helloOnCreated() {                                                                                         // 1
                                                                                                                      //
    this.counter = new ReactiveVar(0);                                                                                // 4
  }                                                                                                                   // 6
                                                                                                                      //
  return helloOnCreated;                                                                                              // 1
}());                                                                                                                 // 1
                                                                                                                      //
...
Template.homeIndex.events({                                                                                           // 18
                                                                                                                      //
  'click .btn-facebook': function () {                                                                                // 20
    function clickBtnFacebook(event) {                                                                                // 20
      ...
      Meteor.loginWithFacebook(function (err) {                                                                       // 22
        if (!err) {                                                                                                   // 23
          Router.go('/');                                                                                             // 24
                                                                                                                      ...
                                                                                                                      //
    return clickBtnFacebook;                                                                                          // 20
  }(),                                                                                                                // 20
                                                                                                                      //
  'click .logout': function () {                                                                                      // 29
    function clickLogout(event) {                                                                                     // 29
      event.preventDefault();                                                                                         // 30
      Meteor.logout();                                                                                                // 31
    }                                                                                                                 // 32
                                                                                                                      //
    return clickLogout;                                                                                               // 29
  }(),                                                                                                                // 29
  //buttons for clock to set time of practice                                                                         //
  'click .oneAM': function () {                                                                                       // 34
    function clickOneAM(event, instance) {                                                                            // 34
      event.preventDefault();                                                                                         // 35
      instance.counter.set(moment("1:00", "h:mm").format("hh:mm "));                                                  // 36
    }                                                                                                                 // 37
                                                                                                                      //
    return clickOneAM;                                                                                                // 34
  }(),                                                                                                                // 34
  'click .twoAM': function () {                                                                                       // 38
    function clickTwoAM(event, instance) {                                                                            // 38
      event.preventDefault();                                                                                         // 39
      instance.counter.set(moment("2:00", "h:mm").format("hh:mm "));                                                  // 40
    }                                                                                                                 // 41
                                                                                                                      //
    return clickTwoAM;                                                                                                // 38
  }(),                                                                                                                // 38
  'click .threeAM': function () {                                                                                     // 42
    function clickThreeAM(event, instance) {                                                                          // 42
      event.preventDefault();                                                                                         // 43
      instance.counter.set(moment("3:00", "h:mm").format("hh:mm "));                                                  // 44
    }                                                                                                                 // 45
                                                                                                                      //
    return clickThreeAM;                                                                                              // 42
  }(),                                                                                                                // 42
  'click .fourAM': function () {                                                                                      // 46
    function clickFourAM(event, instance) {                                                                           // 46
      event.preventDefault();                                                                                         // 47
      instance.counter.set(moment("4:00", "h:mm").format("hh:mm "));                                                  // 48
    }                                                                                                                 // 49
                                                                                                                      //
    return clickFourAM;                                                                                               // 46
  }(),                                                                                                                // 46
  'click .fiveAM': function () {                                                                                      // 50
    function clickFiveAM(event, instance) {                                                                           // 50
      event.preventDefault();                                                                                         // 51
      instance.counter.set(moment("5:00", "h:mm").format("hh:mm "));                                                  // 52
    }                                                                                                                 // 53
                                                                                                                      //
    return clickFiveAM;                                                                                               // 50
  }(),                                                                                                                // 50
  'click .sixAM': function () {                                                                                       // 54
    function clickSixAM(event, instance) {                                                                            // 54
      event.preventDefault();                                                                                         // 55
      instance.counter.set(moment("6:00", "h:mm").format("hh:mm "));                                                  // 56
    }                                                                                                                 // 57
                                                                                                                      //
    return clickSixAM;                                                                                                // 54
  }(),                                                                                                                // 54
  'click .sevenAM': function () {                                                                                     // 58
    function clickSevenAM(event, instance) {                                                                          // 58
      event.preventDefault();                                                                                         // 59
      instance.counter.set(moment("7:00", "h:mm").format("hh:mm "));                                                  // 60
    }                                                                                                                 // 61
                                                                                                                      //
    return clickSevenAM;                                                                                              // 58
  }(),                                                                                                                // 58
  'click .eightAM': function () {                                                                                     // 62
    function clickEightAM(event, instance) {                                                                          // 62
      event.preventDefault();                                                                                         // 63
      instance.counter.set(moment("8:00", "h:mm").format("hh:mm "));                                                  // 64
    }                                                                                                                 // 65
                                                                                                                      //
    return clickEightAM;                                                                                              // 62
  }(),                                                                                                                // 62
                                                                                                                      //
  'click .confirmPracticeTime': function () {                                                                         // 67
    function clickConfirmPracticeTime(event, instance) {                                                              // 67
      ...
      Bert.alert('you have confirmed your practice time at ' + instance.counter.get(), 'success', 'growl-top-right');
                                                                                                                      ...
                                                                                                                      //
    return clickConfirmPracticeTime;                                                                                  // 67
  }()                                                                                                                 // 67
                                                                                                                      //
});                                                                                                                   // 18
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
Template.practiceToday.events({                                                                                       // 14
  'click .thumbUp': function () {                                                                                     // 15
    function clickThumbUp(event) {                                                                                    // 15
      event.preventDefault();                                                                                         // 16
                                                                                                                      //
      Router.go('/confirm');                                                                                          // 18
    }                                                                                                                 // 19
                                                                                                                      //
    return clickThumbUp;                                                                                              // 15
  }(),                                                                                                                // 15
  'click .notToday': function () {                                                                                    // 20
    function clickNotToday(event) {                                                                                   // 20
      event.preventDefault();                                                                                         // 21
      Router.go('/noConfirm');                                                                                        // 22
    }                                                                                                                 // 23
                                                                                                                      //
    return clickNotToday;                                                                                             // 20
  }()                                                                                                                 // 20
                                                                                                                      //
});                                                                                                                   // 14
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
